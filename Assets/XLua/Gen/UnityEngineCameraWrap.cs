...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineCameraWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(type, L, translator, 0, 36, 51, 38);
		    ...
		    try {
                ...
                
                {
                    UnityEngine.Vector3 _position;translator.Get(L, 2, out _position);
                        ...
                        UnityEngine.Ray gen_ret = gen_to_be_invoked.ViewportPointToRay( _position );
		    ...
		    try {
                ...
                
                {
                    UnityEngine.Vector3 _position;translator.Get(L, 2, out _position);
                        ...
                        UnityEngine.Ray gen_ret = gen_to_be_invoked.ScreenPointToRay( _position );
                        translator.PushUnityEngineRay(L, gen_ret);
